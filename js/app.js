const soruListesi = [
  new Soru(
    ...
    { a: "Node.js", b: "Typescripts", c: "Nuget", d: "Npm" },
    "b"
  ),
  new Soru(
    "2-Hangisi frontend kapsaminda degerlendirilmez?",
    { a: "Css", b: "Html", c: "javascript", d: "Sql" },
    "d"
  ),
  new Soru(
    "3-Hangisi backend kapsaminda degerlendirilir?",
    { a: "Node.js", b: "Typescripts", c: "Angular", d: "React" },
    "a"
  ),
  new Soru(
